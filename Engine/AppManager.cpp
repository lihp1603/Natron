...
AppManager::initPython()
{
    ...
    //If this is set, Python won鈥檛 add the user site-packages directory to sys.path.
...
#     endif
    ...
    //
    // The argument should point to a zero-terminated character string in static storage whose contents will not change for the duration of the program鈥檚 execution
